...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CORTEX_CALLER", () => {
    process.env["CORTEX_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CORTEX_CALLER", () => {
    process.env["CORTEX_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CORTEX_CALLER", () => {
    process.env["CORTEX_CALLER"] = "unknown"
